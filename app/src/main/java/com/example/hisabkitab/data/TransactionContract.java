...
public final class TransactionContract {
     ...
     */
    public static final String PATH_TRANSACTION = "transaction";   // it should be pet since my table name is pet instead of pets
    ...
    public static final class TransactionEntry implements BaseColumns{
          // the content uri to access pet data in petprovider

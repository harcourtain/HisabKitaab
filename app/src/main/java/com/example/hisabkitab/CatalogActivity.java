...
/**
 * Displays list of transactions that were entered and stored in the app.
 */
...
//        displayDatabaseInfo();
//        mTransactionDbHelper = new TransactionDbHelper(this);
...
////        Cursor cursor = db.rawQuery("SELECT * FROM " + TransactionContract.TransactionEntry.TABLE_NAME, null);
...
////        Cursor cursor = db.query(TransactionContract.PetEntry.TABLE_NAME,  // making cursor object
////                projection,
////                null,
////                null,
////                null,
////                null,
////                null);
//        Cursor cursor = getContentResolver().query(TransactionEntry.CONTENT_URI,projection,null,null,null);
